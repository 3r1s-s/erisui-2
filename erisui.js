(function(h,g){typeof exports=="object"&&typeof module<"u"?g(exports):typeof define=="function"&&define.amd?define(["exports"],g):(h=typeof globalThis<"u"?globalThis:h||self,g(h.eui={}))})(this,(function(h){"use strict";var it=Object.defineProperty;var st=(h,g,p)=>g in h?it(h,g,{enumerable:!0,configurable:!0,writable:!0,value:p}):h[g]=p;var v=(h,g,p)=>st(h,typeof g!="symbol"?g+"":g,p);class g extends HTMLElement{static get observedAttributes(){return["size","border-radius","name","color"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host {
                    aspect-ratio: 1 / 1;
                    width: fit-content;
        ...
        `}}customElements.define("eui-loader",M);class R extends HTMLElement{static get observedAttributes(){return["value","intermediate","id"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                .progressbar {
                    width: 100%;
                    height: 5px;
        ...
        `}set value(t){this.setAttribute("value",t)}set intermediate(t){t?this.setAttribute("intermediate",""):this.removeAttribute("intermediate")}set id(t){this.setAttribute("id",t)}get intermediate(){return this.hasAttribute("intermediate")}get value(){return this.getAttribute("value")}attributeChangedCallback(){this.connectedCallback()}connectedCallback(){const t=this.shadowRoot.querySelector(".progress");this.hasAttribute("id")&&(t.id=this.getAttribute("id")),this.hasAttribute("intermediate")?t.classList.add("intermediate"):t.classList.remove("intermediate"),this.hasAttribute("value")&&(t.style.width=this.getAttribute("value")+"%")}}customElements.define("eui-progressbar",R);const y={is:{iPhone:/iPhone/.test(navigator.userAgent),iPad:/iPad/.test(navigator.userAgent),iOS:/iPhone|iPad|iPod/.test(navigator.userAgent),android:/Android/.test(navigator.userAgent),mobile:/Mobi|Android/i.test(navigator.userAgent)},prefers:{language:navigator.language||navigator.userLanguage,reducedMotion:window.matchMedia("(prefers-reduced-motion: reduce)").matches,reducedTransparency:window.matchMedia("(prefers-reduced-transparency: reduce)").matches},supports:{share:typeof navigator.share=="function",directDownload:"download"in document.createElement("a"),haptics:"vibrate"in navigator||"Vibrate"in window||typeof window.navigator.vibrate=="function"},userAgent:navigator.userAgent},H=Object.freeze(Object.defineProperty({__proto__:null,device:y},Symbol.toStringTag,{value:"Module"}));function $(){try{const a=document.createElement("label");a.ariaHidden="true",a.style.display="none";const t=document.createElement("input");t.type="checkbox",t.setAttribute("switch",""),a.appendChild(t),document.head.appendChild(a),a.click(),document.head.removeChild(a)}catch{}}function x(a){y.supports.haptics?navigator.vibrate(a||50):y.is.iPhone&&$()}const _=Object.freeze(Object.defineProperty({__proto__:null,haptic:x},Symbol.toStringTag,{value:"Module"})),E=(()=>{let a={},t;try{a=JSON.parse(localStorage.getItem(t)||"{}")}catch(i){console.error(i)}return{get(i){return a[i]},set(i,e){a[i]=e,localStorage.setItem(t,JSON.stringify(a))},delete(i){delete a[i],localStorage.setItem(t,JSON.stringify(a))},all(){return a},clear(){a={},localStorage.setItem(t,JSON.stringify(a))},name(i){t=i;try{a=JSON.parse(localStorage.getItem(t)||"{}")}catch(e){console.error(e)}},settings:{get(i){return a&&a.settings&&a.settings[i]},set(i,e){a.settings||(a.settings={}),a.settings[i]=e,localStorage.setItem(t,JSON.stringify(a))},delete(i){a.settings&&(delete a.settings[i],localStorage.setItem(t,JSON.stringify(a)))},all(){return a.settings||{}},clear(){a.settings&&(a.settings={},localStorage.setItem(t,JSON.stringify(a)))}}}})(),I=E.settings,F=Object.freeze(Object.defineProperty({__proto__:null,settings:I,storage:E},Symbol.toStringTag,{value:"Module"}));class j extends HTMLElement{static get observedAttributes(){return["selected"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                .switch {
        ...
        `}connectedCallback(){this.inputEl=this.shadowRoot.querySelector("input"),this.switchEl=this.shadowRoot.querySelector(".switch"),this.updateFromAttribute(),this.switchEl.addEventListener("click",()=>this.toggle())}toggle(){this.selected=!this.selected,x(),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}updateFromAttribute(){const t=this.hasAttribute("selected");this.inputEl.checked=t,this.switchEl.classList.toggle("selected",t)}attributeChangedCallback(t,i,e){t==="selected"&&this.inputEl&&this.updateFromAttribute()}get selected(){return this.hasAttribute("selected")}set selected(t){t?this.setAttribute("selected",""):this.removeAttribute("selected")}}customElements.define("eui-switch",j);class D extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.shadowRoot.innerHTML=`
            ...
            <slot></slot>
        `,this.addEventListener("pointerdown",t=>{const i=document.createElement("span"),e=t.currentTarget,o=Math.max(e.offsetWidth,e.offsetHeight);i.classList.add("ripple"),i.style.left=t.clientX-e.getBoundingClientRect().left-o/2+"px",i.style.top=t.clientY-e.getBoundingClientRect().top-o/2+"px",i.style.width=o+"px",i.style.height=o+"px",this.shadowRoot.appendChild(i),setTimeout(()=>{i.remove()},600)})}}customElements.define("eui-chip",D);const w="",f=(()=>{const a=[];function t(r,c){const u=[],b=r.replace(/:([^/]+)/g,(k,C)=>(u.push(C),"([^/]+)")).replace(/\//g,"\\/"),m=new RegExp(`^${w}${b}$`);a.push({regex:m,paramNames:u,renderFn:c})}function i(r){for(const{regex:c,paramNames:u,renderFn:b}of a){const m=r.match(c);if(m){const k={};return u.forEach((C,et)=>{k[C]=decodeURIComponent(m[et+1])}),{renderFn:b,params:k}}}return null}function e(r,c=!0){r.startsWith(w)||(r=w+(r.startsWith("/")?"":"/")+r);const u=r.split(/[?#]/)[0];if(u===window.location.pathname&&r.includes("#")){c&&history.pushState({},"",r);const m="#"+r.split("#")[1];o(m);return}const b=i(u);if(b)if(c&&history.pushState({},"",r),b.renderFn(b.params),window.dispatchEvent(new CustomEvent("route-changed",{detail:{path:r}})),r.includes("#")){const m="#"+r.split("#")[1];setTimeout(()=>o(m),100)}else{const m=document.getElementById("main");m&&m.scrollTo(0,0)}else n?(c&&history.pushState({},"",r),n()):console.warn(`No route found for ${u}`)}function o(r){if(r)try{const c=document.querySelector(r);c&&c.scrollIntoView({behavior:"smooth"})}catch{console.warn("Invalid hash:",r)}}let n=null;function s(r){n=r}function l(){history.back()}function d(){return window.location.pathname.replace(w,"")||"/"}return window.addEventListener("popstate",()=>{const r=window.location.pathname+window.location.search+window.location.hash;e(r,!1)}),window.addEventListener("click",r=>{if(r.button!==0||r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)return;const c=r.target.closest("a");if(!c||c.hasAttribute("download")||c.getAttribute("target")==="_blank")return;const u=c.getAttribute("href");if(!(!u||u.startsWith("http")&&!u.startsWith(window.location.origin))){if(r.preventDefault(),u.startsWith("#")){history.pushState({},"",u),o(u);return}e(u)}}),{add:t,navigate:e,back:l,location:d,setNotFound:s}})();async function q(a){try{const t=document.getElementById("main");t.classList.add("fade-out"),await new Promise(e=>setTimeout(e,200));const i=await fetch(`/src/pages/${a}.html`).then(e=>e.text());t.innerHTML=i,t.classList.remove("fade-out"),t.classList.add("fade-in"),window.location.hash?setTimeout(()=>{try{const e=document.querySelector(window.location.hash);e&&e.scrollIntoView({behavior:"smooth"})}catch{}},100):t&&t.scrollTo(0,0),setTimeout(()=>{t.classList.remove("fade-in")},200)}catch(t){console.error("Page load failed:",t)}}class B extends HTMLElement{constructor(){super();v(this,"handleClick",()=>{const i=this.getAttribute("path");i&&f.navigate(i)});this.attachShadow({mode:"open"})}static get observedAttributes(){return["path","icon","label","badge","active","avatar-src","avatar-name"]}connectedCallback(){this.hasRendered||(this.render(),this.setupEventListeners(),this.hasRendered=!0),this.updateContent(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.removeEventListener("click",this.handleClick)}attributeChangedCallback(i,e,o){if(e!==o&&this.hasRendered){if(i==="active")return;this.updateContent()}}setupEventListeners(){this.addEventListener("pointerdown",i=>{const e=document.createElement("span"),o=i.currentTarget,n=o.getBoundingClientRect(),s=Math.max(o.offsetWidth,o.offsetHeight),l=s/2;e.classList.add("ripple"),e.style.width=`${s}px`,e.style.height=`${s}px`,e.style.left=`${i.clientX-n.left-l}px`,e.style.top=`${i.clientY-n.top-l}px`,this.shadowRoot.appendChild(e),e.addEventListener("animationend",()=>{e.remove()})})}updateContent(){const i=this.getAttribute("icon"),e=this.getAttribute("avatar-src"),o=this.getAttribute("avatar-name"),n=this.getAttribute("label")||"",s=this.getAttribute("badge"),l=this.shadowRoot.querySelector(".badge");if(s)if(l)l.textContent=s;else{const c=document.createElement("span");c.className="badge",c.textContent=s,this.shadowRoot.appendChild(c)}else l&&l.remove();const d=this.shadowRoot.querySelector("slot[name='icon']");if(d)if(e||o){let c='<eui-avatar size="24"';o&&(c+=` name="${o}"`),c+=">",e&&(c+=`<img src="${e}" alt="${o||"Avatar"}" />`),c+="</eui-avatar>",d.innerHTML=c}else{const c=d.querySelector("eui-icon");i&&c?c.getAttribute("name")!==i&&c.setAttribute("name",i):i?d.innerHTML=`<eui-icon width="24" height="24" name="${i}"></eui-icon>`:d.innerHTML=""}const r=this.shadowRoot.querySelector(".label");r&&(r.textContent=n)}render(){this.shadowRoot.innerHTML=`
        <style>
            :host {
                position: relative;
                overflow: hidden;
        ...
        `}}customElements.define("eui-nav-item",B);class O extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.updateActiveState(),window.addEventListener("popstate",()=>this.updateActiveState()),window.addEventListener("route-changed",()=>this.updateActiveState()),window.addEventListener("toggle-nav",()=>this.classList.toggle("expanded"))}render(){this.shadowRoot.innerHTML=`
        <style>
            :host {
                position: fixed;
        ...
        <div class="app-nav-container">
            ...
            <div class="nav-items">
                ${this.navItems.map(t=>{var o,n;if(t.type==="divider")return'<div style="height: 1px; background: var(--app-300); margin: 0.5rem 0;"></div>';const i=((o=t.avatar)==null?void 0:o.src)||"",e=((n=t.avatar)==null?void 0:n.name)||"";return`<eui-nav-item path="${t.path}" icon="${t.icon}" avatar-src="${i}" avatar-name="${e}" label="${t.label}"></eui-nav-item>`}).join("")}
            </div>
        </div>
        `}set navItems(t){this._navItems=t,this.render(),this.updateActiveState()}get navItems(){return this._navItems||[]}updateActiveState(t){t||(t=f.location()),t.startsWith("/")||(t="/"+t),this.shadowRoot.querySelectorAll("eui-nav-item").forEach(e=>{e.getAttribute("path")===t?e.setAttribute("active",""):e.removeAttribute("active")})}}customElements.define("eui-app-nav",O);class N extends HTMLElement{static get observedAttributes(){return["type","title","subtitle","img"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host {
                    border-radius: 24px;
        ...
        `}connectedCallback(){this.hd=this.shadowRoot.querySelector(".header"),this.hasAttribute("type")&&this.hd.classList.add(this.getAttribute("type"))}attributeChangedCallback(t,i,e){const o=this.shadowRoot.querySelector("h1"),n=this.shadowRoot.querySelector("p"),s=this.shadowRoot.querySelector(".img");t==="title"&&(o.textContent=e),t==="subtitle"&&(n.textContent=e),t==="img"&&(s.style.backgroundImage=e?`url(${e})`:"")}}customElements.define("eui-header",N);class P extends HTMLElement{static get observedAttributes(){return["selected"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host {
                    display: inline-block;
        ...
        `;const e=this.shadowRoot.querySelector(i);t&&e.setAttribute("href",t),this.hasAttribute("type")&&e.classList.add(this.getAttribute("type")),this.hasAttribute("icon")&&e.classList.add("icon"),this.hasAttribute("width")&&(e.style.width=this.getAttribute("width")+"px"),this.hasAttribute("height")&&(e.style.height=this.getAttribute("height")+"px"),this.hasAttribute("border-radius")&&(e.style.borderRadius=this.getAttribute("border-radius")+"px"),e.addEventListener("pointerdown",o=>{const n=document.createElement("span"),s=o.currentTarget,l=s.getBoundingClientRect(),d=Math.max(s.offsetWidth,s.offsetHeight),r=d/2;n.classList.add("ripple"),n.style.width=`${d}px`,n.style.height=`${d}px`,n.style.left=`${o.clientX-l.left-r}px`,n.style.top=`${o.clientY-l.top-r}px`,e.appendChild(n),n.addEventListener("animationend",()=>{n.remove()})})}}v(A,"observedAttributes",["type","width","height","border-radius","icon","link","href"]),customElements.define("eui-button",A);class U extends HTMLElement{static get observedAttributes(){return["type","anchor"]}constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.hd=this.shadowRoot.querySelector(".hd"),this.hasAttribute("type")&&this.hd.classList.add(this.getAttribute("type"))}render(){this.shadowRoot.innerHTML=`
            <style>
                :host {
                    display: block;
                    position: relative;
            ...
            `:""}
        `}}customElements.define("eui-heading",U);function V(a){const e=Date.now()-a,o=Math.floor(e/1e3),n=Math.floor(o/60),s=Math.floor(n/60),l=Math.floor(s/24),d=Math.floor(l/30),r=Math.floor(d/12);return r>0?`${r}y`:d>0?`${d}mo`:l>0?`${l}d`:s>0?`${s}h`:n>0?`${n}m`:`${o}s`}function Y(a){const e=Date.now()-a,o=Math.floor(e/1e3),n=Math.floor(o/60),s=Math.floor(n/60),l=Math.floor(s/24),d=Math.floor(l/30),r=Math.floor(d/12);return r>0?`${r} year${r>1?"s":""} ago`:d>0?`${d} month${d>1?"s":""} ago`:l>0?`${l} day${l>1?"s":""} ago`:s>0?`${s} hour${s>1?"s":""} ago`:n>0?`${n} minute${n>1?"s":""} ago`:`${o} second${o>1?"s":""} ago`}function W(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/`/g,"&#96;").replace(/'/g,"&#39;")}function L(a){const t=document.createElement("input");t.value=a,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}const X=Object.freeze(Object.defineProperty({__proto__:null,copystr:L,joinedAgo:Y,sanitize:W,timeAgo:V},Symbol.toStringTag,{value:"Module"}));class Z extends HTMLElement{static get observedAttributes(){return["copy","id","type","language"]}constructor(){super(),this.attachShadow({mode:"open"}),this._boundCopy=this._onCopy.bind(this),this._isRendered=!1}connectedCallback(){this._isRendered||(this.render(),this._isRendered=!0)}attributeChangedCallback(t,i,e){this._isRendered&&i!==e&&this.render()}render(){const t=this.hasAttribute("copy"),i=this.getAttribute("language")||"text";this.shadowRoot.innerHTML=`
            <style>
            :host {
                position: relative;
                display: block;
...
`),o=e.filter(s=>s.trim()).map(s=>s.match(/^\s*/)[0].length),n=o.length?Math.min(...o):0;return e.map(s=>s.slice(n)).join(`
`)}_unescapeHtml(t){const i=document.createElement("textarea");return i.innerHTML=t,i.value}_highlight(t,i){t=t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");const e={};let o=0;function n(s,l){const d=`__TOKEN_${l}_${o++}__`;return e[d]=`<span class="token ${l}">${s}</span>`,d}return["javascript","js","json","bash","sh","css"].includes(i)?(t=t.replace(/("(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,s=>n(s,"string")),i==="bash"||i==="sh"?t=t.replace(/(#.*$)/gm,s=>n(s,"comment")):i==="css"?t=t.replace(/(\/\*[\s\S]*?\*\/)/g,s=>n(s,"comment")):t=t.replace(/(\/\/.*$|\/\*[\s\S]*?\*\/)/gm,s=>n(s,"comment"))):["html","xml"].includes(i)&&(t=t.replace(/(&lt;!--[\s\S]*?--&gt;)/g,s=>n(s,"comment")),t=t.replace(/(&lt;\/?[a-z0-9:-]+)/gi,s=>n(s,"tag"))),i==="javascript"||i==="js"||i==="json"?(t=t.replace(/\b(const|let|var|if|else|for|while|return|function|class|import|export|from|default|switch|case|break|continue|new|this|async|await)\b/g,'<span class="token keyword">$1</span>'),t=t.replace(/\b(true|false|null|undefined)\b/g,'<span class="token boolean">$1</span>'),t=t.replace(/\b([a-zA-Z0-9_]+)\s*(?=\()/g,'<span class="token function">$1</span>')):i==="bash"||i==="sh"?(t=t.replace(/\b(npm|npx|node|git|cd|ls|mkdir|rm|mv|cp|echo|cat|sudo|docker|brew|grep|curl|wget|chmod|chown|touch)\b/g,'<span class="token keyword">$1</span>'),t=t.replace(/\b(install|run|build|start|test|dev|init|clone|pull|push|commit|add|checkout|branch|merge)\b/g,'<span class="token function">$1</span>'),t=t.replace(/(\s-+[a-zA-Z0-9-]+)/g,'<span class="token attr-name">$1</span>'),t=t.replace(/(\$[A-Z0-9_]+)/g,'<span class="token number">$1</span>')):i==="html"||i==="xml"?(t=t.replace(/\s([a-z0-9:-]+)=/gi,(s,l)=>" "+n(l,"attr-name")+"="),t=t.replace(/(".*?")/g,s=>n(s,"attr-value")),t=t.replace(/&gt;/g,'<span class="token tag">&gt;</span>')):i==="css"&&(t=t.replace(/([a-z-]+)(?=:)/g,'<span class="token keyword">$1</span>')),Object.keys(e).reverse().forEach(s=>{t=t.replace(s,e[s])}),t}_onCopy(){L(this._getFormattedText());const t=this.copyBtn.querySelector("eui-icon");if(t){const i=t.getAttribute("name");t.setAttribute("name","check"),setTimeout(()=>t.setAttribute("name",i),2e3)}}disconnectedCallback(){this.copyBtn&&this.copyBtn.removeEventListener("click",this._boundCopy)}}customElements.define("eui-code",Z);class J extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}static get observedAttributes(){return["name"]}attributeChangedCallback(t,i,e){t==="name"&&(this.render(),this.setupEventListeners())}setupEventListeners(){const t=this.shadowRoot.querySelector("#nav-toggle");t&&t.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("toggle-nav"))})}render(){const t=this.getAttribute("name")||"Title";this.shadowRoot.innerHTML=`
        <style>
            :host {
                display: block;
                width: 100%;
        ...
        `}}customElements.define("eui-app-titlebar",J);class K extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._handleMouseDown=this._addRipple.bind(this)}connectedCallback(){this.render(),this.setupEventListeners()}static get observedAttributes(){return["elevated","interactive","ripple"]}attributeChangedCallback(t,i,e){i!==e&&t==="ripple"&&this.setupEventListeners()}setupEventListeners(){this.removeEventListener("mousedown",this._handleMouseDown),this.hasAttribute("ripple")&&this.addEventListener("mousedown",this._handleMouseDown)}_addRipple(t){const i=this.getBoundingClientRect(),e=document.createElement("span"),o=Math.max(i.width,i.height),n=o/2;e.style.width=e.style.height=`${o}px`,e.style.left=`${t.clientX-i.left-n}px`,e.style.top=`${t.clientY-i.top-n}px`,e.classList.add("ripple"),this.shadowRoot.querySelector(".surface").appendChild(e),e.addEventListener("animationend",()=>{e.remove()})}render(){this.shadowRoot.innerHTML=`
        <style>
            :host {
                display: block;
                border-radius: 12px;
        ...
        `}}customElements.define("eui-surface",K);class G extends HTMLElement{static get observedAttributes(){return["value","min","max","step","label","vertical","disabled","thickness"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host {
                    display: flex;
                    flex-direction: column;
        ...
        `}connectedCallback(){this.inputEl=this.shadowRoot.querySelector("input"),this.labelEl=this.shadowRoot.querySelector(".label"),this.valueEl=this.shadowRoot.querySelector(".value-badge"),this.trackFillEl=this.shadowRoot.querySelector(".track-fill"),this.sliderThumbEl=this.shadowRoot.querySelector(".slider-thumb"),this.containerEl=this.shadowRoot.querySelector(".slider-container"),this.inputEl.min=this.getAttribute("min")||0,this.inputEl.max=this.getAttribute("max")||100,this.inputEl.step=this.getAttribute("step")||1,this.inputEl.value=this.getAttribute("value")||50,this.hasAttribute("label")&&(this.labelEl.textContent=this.getAttribute("label")),this.hasAttribute("disabled")&&(this.inputEl.disabled=!0),this.hasAttribute("thickness")&&this.style.setProperty("--track-thickness",this.getAttribute("thickness")),this.updateUI(),this.inputEl.addEventListener("input",()=>{this.updateValue(this.inputEl.value),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}),this.inputEl.addEventListener("change",()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),this.inputEl.addEventListener("mousedown",()=>this.sliderThumbEl.classList.add("active")),this.inputEl.addEventListener("touchstart",()=>this.sliderThumbEl.classList.add("active"),{passive:!0}),this.onUp=()=>this.sliderThumbEl.classList.remove("active"),window.addEventListener("mouseup",this.onUp),window.addEventListener("touchend",this.onUp),this.resizeObserver=new ResizeObserver(()=>this.updateDimensions()),this.resizeObserver.observe(this.containerEl),this.updateDimensions()}disconnectedCallback(){this.resizeObserver&&this.resizeObserver.disconnect(),window.removeEventListener("mouseup",this.onUp),window.removeEventListener("touchend",this.onUp)}updateDimensions(){!this.inputEl||!this.containerEl||(this.hasAttribute("vertical")?this.inputEl.style.width=`${this.containerEl.offsetHeight}px`:this.inputEl.style.width="")}updateValue(t){this.setAttribute("value",t),this.updateUI()}updateUI(){if(!this.inputEl)return;const t=parseFloat(this.inputEl.min),i=parseFloat(this.inputEl.max),e=parseFloat(this.inputEl.value),o=(e-t)/(i-t)*100;this.containerEl.style.setProperty("--progress",`${o}%`);const n=o/100*20;this.containerEl.style.setProperty("--thumb-offset",`${n}px`),this.valueEl.textContent=e}attributeChangedCallback(t,i,e){this.inputEl&&(t==="value"&&e!==this.inputEl.value?(this.inputEl.value=e,this.updateUI()):["min","max","step"].includes(t)?(this.inputEl[t]=e,this.updateUI()):t==="label"?this.labelEl.textContent=e:t==="vertical"?this.updateDimensions():t==="disabled"?this.inputEl.disabled=e!==null:t==="thickness"&&(e?this.style.setProperty("--track-thickness",e):this.style.removeProperty("--track-thickness")))}get value(){return parseFloat(this.inputEl.value)}set value(t){this.setAttribute("value",t)}}customElements.define("eui-slider",G);class Q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}set tabItems(t){this._tabItems=t,this.render()}get tabItems(){return this._tabItems||[]}badge(t,i){const e=this.tabItems.findIndex(n=>n.path===t);e>-1&&(this.tabItems[e].badge=i);const o=this.shadowRoot.querySelector(`eui-tab-item[path="${t}"]`);o&&(i?o.setAttribute("badge",i):o.removeAttribute("badge"))}render(){this.shadowRoot.innerHTML=`
            ...
            <div class="inner">
                <slot>
                    ${this.tabItems.map(t=>{var o,n;const i=((o=t.avatar)==null?void 0:o.src)||"",e=((n=t.avatar)==null?void 0:n.name)||"";return`<eui-tab-item path="${t.path}" icon="${t.icon}" avatar-src="${i}" avatar-name="${e}" label="${t.label}" badge="${t.badge||""}"></eui-tab-item>`}).join("")}
                </slot>
            </div>
        `}}customElements.define("eui-tab-bar",Q);class tt extends HTMLElement{constructor(){super();v(this,"handleClick",()=>{const i=this.getAttribute("path");i&&f.navigate(i)});this.attachShadow({mode:"open"})}static get observedAttributes(){return["path","icon","label","badge","active","avatar-src","avatar-name"]}connectedCallback(){this.hasRendered||(this.render(),this.setupEventListeners(),this.hasRendered=!0),this.updateContent(),this.updateActiveState(),this.addEventListener("click",this.handleClick),this._onRouteSubstitute=()=>this.updateActiveState(),window.addEventListener("popstate",this._onRouteSubstitute),window.addEventListener("route-changed",this._onRouteSubstitute)}disconnectedCallback(){this.removeEventListener("click",this.handleClick),window.removeEventListener("popstate",this._onRouteSubstitute),window.removeEventListener("route-changed",this._onRouteSubstitute)}attributeChangedCallback(i,e,o){if(e!==o&&this.hasRendered){if(i==="active")return;this.updateContent(),i==="path"&&this.updateActiveState()}}updateActiveState(){let i=f.location(),e=this.getAttribute("path");i.startsWith("/")||(i="/"+i),e&&!e.startsWith("/")&&(e="/"+e),e&&i===e?this.setAttribute("active",""):this.removeAttribute("active")}setupEventListeners(){this.addEventListener("pointerdown",i=>{const e=document.createElement("span"),o=i.currentTarget,n=o.getBoundingClientRect(),s=Math.max(o.offsetWidth,o.offsetHeight),l=s/2;e.classList.add("ripple"),e.style.width=`${s}px`,e.style.height=`${s}px`,e.style.left=`${i.clientX-n.left-l}px`,e.style.top=`${i.clientY-n.top-l}px`,this.shadowRoot.appendChild(e),e.addEventListener("animationend",()=>{e.remove()})})}updateContent(){const i=this.getAttribute("icon"),e=this.getAttribute("avatar-src"),o=this.getAttribute("avatar-name"),n=this.getAttribute("label")||"",s=this.getAttribute("badge"),l=this.shadowRoot.querySelector(".badge");if(s)if(l)l.textContent=s;else{const c=document.createElement("span");c.className="badge",c.textContent=s,this.shadowRoot.appendChild(c)}else l&&l.remove();const d=this.shadowRoot.querySelector("slot[name='icon']");if(d)if(e||o){let c='<eui-avatar size="24"';o&&(c+=` name="${o}"`),c+=">",e&&(c+=`<img src="${e}" alt="${o||"Avatar"}" />`),c+="</eui-avatar>",d.innerHTML=c}else i?d.innerHTML=`<eui-icon width="20" height="20" name="${i}"></eui-icon>`:d.innerHTML="";const r=this.shadowRoot.querySelector(".label");r&&(r.textContent=n)}render(){this.shadowRoot.innerHTML=`
            <style>
                :host {
                    position: relative;
                    overflow: hidden;
            ...
            <div class="inner">
                ...
                <span class="label"></span>
            <slot></slot>
        `}}customElements.define("eui-tab-item",tt);class S extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.isDragging=!1,this.sy=0,this.startHeight=0,this.y=0,this.t=0,this.vel=0,this.isExpanded=!1,this.startDrag=this.startDrag.bind(this),this.handleDrag=this.handleDrag.bind(this),this.stopDrag=this.stopDrag.bind(this),this.close=this.close.bind(this),this.onOutsideClick=this.onOutsideClick.bind(this),this._returnValue=""}get returnValue(){return this._returnValue}set returnValue(t){this._returnValue=t,t?this.setAttribute("return",t):this.removeAttribute("return")}connectedCallback(){this.render(),this.setupResultListeners(),this.hasAttribute("open")&&this.open()}attributeChangedCallback(t,i,e){i!==e&&(t==="open"?e!==null?this.open():this.classList.contains("closing")||this.close():t==="width"?this.modal&&(this.modal.style.width=e):t==="height"?this.modal&&(this.modal.style.height=e):t==="return"&&(this._returnValue=e||""))}render(){this.shadowRoot.innerHTML=`
            <style>
                :host {
                    position: fixed;
                    top: 0;
        ...
        `,this.modal=this.shadowRoot.querySelector(".modal"),this.modalOuter=this.shadowRoot.querySelector(".modal-outer"),this.handleArea=this.shadowRoot.querySelector("#drag-handle"),this.modalBody=this.shadowRoot.querySelector(".modal-body"),this.modalOuter.addEventListener("click",this.onOutsideClick),this.modal.addEventListener("mousedown",this.startDrag),this.modal.addEventListener("touchstart",this.startDrag,{passive:!1}),this.hasAttribute("width")&&(this.modal.style.width=this.getAttribute("width")),this.hasAttribute("height")&&(this.modal.style.height=this.getAttribute("height"))}setupResultListeners(){window.addEventListener("mousemove",this.handleDrag),window.addEventListener("touchmove",this.handleDrag,{passive:!1}),window.addEventListener("mouseup",this.stopDrag),window.addEventListener("touchend",this.stopDrag)}disconnectedCallback(){window.removeEventListener("mousemove",this.handleDrag),window.removeEventListener("touchmove",this.handleDrag),window.removeEventListener("mouseup",this.stopDrag),window.removeEventListener("touchend",this.stopDrag)}onOutsideClick(t){t.target===this.modalOuter&&this.close()}startDrag(t){if(window.innerWidth>768||this.getAttribute("type")==="alert")return;const i=t.composedPath();if(i.some(s=>s instanceof HTMLButtonElement||s instanceof HTMLAnchorElement||s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement||s.getAttribute&&s.getAttribute("role")==="button"||s.tagName&&s.tagName.toLowerCase().includes("button"))||i.some(s=>s===this.modalBody)&&this.modalBody.scrollTop>0)return;this.isDragging=!0;const n=t.type.startsWith("touch")?t.touches[0].clientY:t.clientY;this.sy=n,this.y=n,this.t=Date.now(),this.startHeight=this.modal.offsetHeight,this.modal.style.transition="none",document.body.style.cursor="ns-resize"}handleDrag(t){if(!this.isDragging)return;t.type.startsWith("touch")&&t.preventDefault();const i=t.type.startsWith("touch")?t.touches[0].clientY:t.clientY,e=Date.now(),o=e-this.t;o>0&&(this.vel=(this.y-i)/o),this.y=i,this.t=e;const n=this.sy-i;let s=this.startHeight+n;const l=window.innerHeight*.95;s>l&&(s=l+(s-l)*.2),this.modal.style.height=`${s}px`}stopDrag(){if(!this.isDragging)return;this.isDragging=!1,this.modal.style.transition="height 0.4s cubic-bezier(0.38, 1.21, 0.22, 1), transform 0.4s cubic-bezier(0.38, 1.21, 0.22, 1)",document.body.style.cursor="";const t=this.modal.offsetHeight;this.vel<-.5||t<200?this.close():this.vel>.5?this.modal.style.height="90%":t>window.innerHeight*.5?this.modal.style.height="90%":this.close(),this.vel=0}open(){this._returnValue="",this.hasAttribute("open")||this.setAttribute("open",""),x(),this.modal&&(window.innerWidth<=768&&this.getAttribute("type")!=="alert"?(this.modal.style.height=this.getAttribute("height")||"90%",this.modal.style.transform="translateY(0)"):(this.modal.style.height=this.getAttribute("height")||"auto",this.modal.style.transform=""))}close(t){if(this.classList.contains("closing"))return;t!==void 0&&(this.returnValue=t),this.classList.add("closing"),this.modal&&(this.modal.style.transform="",this.modal.style.transition="");const i=window.innerWidth<=768?400:200;setTimeout(()=>{const e=this.hasAttribute("open");this.removeAttribute("open"),requestAnimationFrame(()=>{this.classList.remove("closing"),this.modal&&(this.modal.style.height="",this.modal.style.transform="",this.modal.style.transition="")}),e&&this.dispatchEvent(new CustomEvent("close",{detail:{returnValue:this.returnValue},bubbles:!0,composed:!0}))},i)}}v(S,"observedAttributes",["width","height","open","type","return"]),customElements.define("eui-modal",S),typeof window<"u"&&console.log("ErisUI loaded successfully"),h.device=H,h.haptics=_,h.icons=p,h.loadPage=q,h.router=f,h.storage=F,h.utils=X,Object.defineProperty(h,Symbol.toStringTag,{value:"Module"})}));
