(function(h,g){typeof exports=="object"&&typeof module<"u"?g(exports):typeof define=="function"&&define.amd?define(["exports"],g):(h=typeof globalThis<"u"?globalThis:h||self,g(h.eui={}))})(this,(function(h){"use strict";var et=Object.defineProperty;var it=(h,g,p)=>g in h?et(h,g,{enumerable:!0,configurable:!0,writable:!0,value:p}):h[g]=p;var x=(h,g,p)=>it(h,typeof g!="symbol"?g+"":g,p);class g extends HTMLElement{static get observedAttributes(){return["size","border-radius","name","color"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
        ...
        `}connectedCallback(){this.inputEl=this.shadowRoot.querySelector("input"),this.switchEl=this.shadowRoot.querySelector(".switch"),this.updateFromAttribute(),this.switchEl.addEventListener("click",()=>this.toggle())}toggle(){this.selected=!this.selected,y(),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}updateFromAttribute(){const t=this.hasAttribute("selected");this.inputEl.checked=t,this.switchEl.classList.toggle("selected",t)}attributeChangedCallback(t,i,e){t==="selected"&&this.inputEl&&this.updateFromAttribute()}get selected(){return this.hasAttribute("selected")}set selected(t){t?this.setAttribute("selected",""):this.removeAttribute("selected")}}customElements.define("eui-switch",I);class j extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.shadowRoot.innerHTML=`
            ...
            <slot></slot>
        `,this.addEventListener("pointerdown",t=>{const i=document.createElement("span"),e=t.currentTarget,n=Math.max(e.offsetWidth,e.offsetHeight);i.classList.add("ripple"),i.style.left=t.clientX-e.getBoundingClientRect().left-n/2+"px",i.style.top=t.clientY-e.getBoundingClientRect().top-n/2+"px",i.style.width=n+"px",i.style.height=n+"px",this.shadowRoot.appendChild(i),setTimeout(()=>{i.remove()},600)})}}customElements.define("eui-chip",j);const v="",f=(()=>{const s=[];function t(r,l){const u=[],m=r.replace(/:([^/]+)/g,(k,C)=>(u.push(C),"([^/]+)")).replace(/\//g,"\\/"),b=new RegExp(`^${v}${m}$`);s.push({regex:b,paramNames:u,renderFn:l})}function i(r){for(const{regex:l,paramNames:u,renderFn:m}of s){const b=r.match(l);if(b){const k={};return u.forEach((C,tt)=>{k[C]=decodeURIComponent(b[tt+1])}),{renderFn:m,params:k}}}return null}function e(r,l=!0){r.startsWith(v)||(r=v+(r.startsWith("/")?"":"/")+r);const u=r.split(/[?#]/)[0];if(u===window.location.pathname&&r.includes("#")){l&&history.pushState({},"",r);const b="#"+r.split("#")[1];n(b);return}const m=i(u);if(m)if(l&&history.pushState({},"",r),m.renderFn(m.params),window.dispatchEvent(new CustomEvent("route-changed",{detail:{path:r}})),r.includes("#")){const b="#"+r.split("#")[1];setTimeout(()=>n(b),100)}else{const b=document.getElementById("main");b&&b.scrollTo(0,0)}else o?(l&&history.pushState({},"",r),o()):console.warn(`No route found for ${u}`)}function n(r){if(r)try{const l=document.querySelector(r);l&&l.scrollIntoView({behavior:"smooth"})}catch{console.warn("Invalid hash:",r)}}let o=null;function a(r){o=r}function c(){history.back()}function d(){return window.location.pathname.replace(v,"")||"/"}return window.addEventListener("popstate",()=>{const r=window.location.pathname+window.location.search+window.location.hash;e(r,!1)}),window.addEventListener("click",r=>{if(r.button!==0||r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)return;const l=r.target.closest("a");if(!l||l.hasAttribute("download")||l.getAttribute("target")==="_blank")return;const u=l.getAttribute("href");if(!(!u||u.startsWith("http")&&!u.startsWith(window.location.origin))){if(r.preventDefault(),u.startsWith("#")){history.pushState({},"",u),n(u);return}e(u)}}),{add:t,navigate:e,back:c,location:d,setNotFound:a}})();async function q(s){try{const t=document.getElementById("main");t.classList.add("fade-out"),await new Promise(e=>setTimeout(e,200));const i=await fetch(`/src/pages/${s}.html`).then(e=>e.text());t.innerHTML=i,t.classList.remove("fade-out"),t.classList.add("fade-in"),window.location.hash?setTimeout(()=>{try{const e=document.querySelector(window.location.hash);e&&e.scrollIntoView({behavior:"smooth"})}catch{}},100):t&&t.scrollTo(0,0),setTimeout(()=>{t.classList.remove("fade-in")},200)}catch(t){console.error("Page load failed:",t)}}class B extends HTMLElement{constructor(){super();x(this,"handleClick",()=>{const i=this.getAttribute("path");i&&f.navigate(i)});this.attachShadow({mode:"open"})}static get observedAttributes(){return["path","icon","label","badge","active","avatar-src","avatar-name"]}connectedCallback(){this.hasRendered||(this.render(),this.setupEventListeners(),this.hasRendered=!0),this.updateContent(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.removeEventListener("click",this.handleClick)}attributeChangedCallback(i,e,n){if(e!==n&&this.hasRendered){if(i==="active")return;this.updateContent()}}setupEventListeners(){this.addEventListener("pointerdown",i=>{const e=document.createElement("span"),n=i.currentTarget,o=n.getBoundingClientRect(),a=Math.max(n.offsetWidth,n.offsetHeight),c=a/2;e.classList.add("ripple"),e.style.width=`${a}px`,e.style.height=`${a}px`,e.style.left=`${i.clientX-o.left-c}px`,e.style.top=`${i.clientY-o.top-c}px`,this.shadowRoot.appendChild(e),e.addEventListener("animationend",()=>{e.remove()})})}updateContent(){const i=this.getAttribute("icon"),e=this.getAttribute("avatar-src"),n=this.getAttribute("avatar-name"),o=this.getAttribute("label")||"",a=this.getAttribute("badge"),c=this.shadowRoot.querySelector(".badge");if(a)if(c)c.textContent=a;else{const l=document.createElement("span");l.className="badge",l.textContent=a,this.shadowRoot.appendChild(l)}else c&&c.remove();const d=this.shadowRoot.querySelector("slot[name='icon']");if(d)if(e||n){let l='<eui-avatar size="24"';n&&(l+=` name="${n}"`),l+=">",e&&(l+=`<img src="${e}" alt="${n||"Avatar"}" />`),l+="</eui-avatar>",d.innerHTML=l}else{const l=d.querySelector("eui-icon");i&&l?l.getAttribute("name")!==i&&l.setAttribute("name",i):i?d.innerHTML=`<eui-icon width="24" height="24" name="${i}"></eui-icon>`:d.innerHTML=""}const r=this.shadowRoot.querySelector(".label");r&&(r.textContent=o)}render(){this.shadowRoot.innerHTML=`
        <style>
            :host {
                position: relative;
                overflow: hidden;
        ...
        <div class="app-nav-container">
            ...
            <div class="nav-items">
                ${this.navItems.map(t=>{var n,o;if(t.type==="divider")return'<div style="height: 1px; background: var(--app-300); margin: 0.5rem 0;"></div>';const i=((n=t.avatar)==null?void 0:n.src)||"",e=((o=t.avatar)==null?void 0:o.name)||"";return`<eui-nav-item path="${t.path}" icon="${t.icon}" avatar-src="${i}" avatar-name="${e}" label="${t.label}"></eui-nav-item>`}).join("")}
            </div>
        </div>
        ...
        `}connectedCallback(){this.hd=this.shadowRoot.querySelector(".header"),this.hasAttribute("type")&&this.hd.classList.add(this.getAttribute("type"))}attributeChangedCallback(t,i,e){const n=this.shadowRoot.querySelector("h1"),o=this.shadowRoot.querySelector("p"),a=this.shadowRoot.querySelector(".img");t==="title"&&(n.textContent=e),t==="subtitle"&&(o.textContent=e),t==="img"&&(a.style.backgroundImage=e?`url(${e})`:"")}}customElements.define("eui-header",O);class P extends HTMLElement{static get observedAttributes(){return["selected"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host {
                    display: inline-block;
        ...
        `;const e=this.shadowRoot.querySelector(i);t&&e.setAttribute("href",t),this.hasAttribute("type")&&e.classList.add(this.getAttribute("type")),this.hasAttribute("icon")&&e.classList.add("icon"),this.hasAttribute("width")&&(e.style.width=this.getAttribute("width")+"px"),this.hasAttribute("height")&&(e.style.height=this.getAttribute("height")+"px"),this.hasAttribute("border-radius")&&(e.style.borderRadius=this.getAttribute("border-radius")+"px"),e.addEventListener("pointerdown",n=>{const o=document.createElement("span"),a=n.currentTarget,c=a.getBoundingClientRect(),d=Math.max(a.offsetWidth,a.offsetHeight),r=d/2;o.classList.add("ripple"),o.style.width=`${d}px`,o.style.height=`${d}px`,o.style.left=`${n.clientX-c.left-r}px`,o.style.top=`${n.clientY-c.top-r}px`,e.appendChild(o),o.addEventListener("animationend",()=>{o.remove()})})}}x(A,"observedAttributes",["type","width","height","border-radius","icon","link","href"]),customElements.define("eui-button",A);class U extends HTMLElement{static get observedAttributes(){return["type","anchor"]}constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.hd=this.shadowRoot.querySelector(".hd"),this.hasAttribute("type")&&this.hd.classList.add(this.getAttribute("type"))}render(){this.shadowRoot.innerHTML=`
            ...
            `:""}
        `}}customElements.define("eui-heading",U);function V(s){const e=Date.now()-s,n=Math.floor(e/1e3),o=Math.floor(n/60),a=Math.floor(o/60),c=Math.floor(a/24),d=Math.floor(c/30),r=Math.floor(d/12);return r>0?`${r}y`:d>0?`${d}mo`:c>0?`${c}d`:a>0?`${a}h`:o>0?`${o}m`:`${n}s`}function D(s){const e=Date.now()-s,n=Math.floor(e/1e3),o=Math.floor(n/60),a=Math.floor(o/60),c=Math.floor(a/24),d=Math.floor(c/30),r=Math.floor(d/12);return r>0?`${r} year${r>1?"s":""} ago`:d>0?`${d} month${d>1?"s":""} ago`:c>0?`${c} day${c>1?"s":""} ago`:a>0?`${a} hour${a>1?"s":""} ago`:o>0?`${o} minute${o>1?"s":""} ago`:`${n} second${n>1?"s":""} ago`}function X(s){return s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/`/g,"&#96;").replace(/'/g,"&#39;")}function L(s){const t=document.createElement("input");t.value=s,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}const W=Object.freeze(Object.defineProperty({__proto__:null,copystr:L,joinedAgo:D,sanitize:X,timeAgo:V},Symbol.toStringTag,{value:"Module"}));class Z extends HTMLElement{static get observedAttributes(){return["copy","id","type","language"]}constructor(){super(),this.attachShadow({mode:"open"}),this._boundCopy=this._onCopy.bind(this),this._isRendered=!1}connectedCallback(){this._isRendered||(this.render(),this._isRendered=!0)}attributeChangedCallback(t,i,e){this._isRendered&&i!==e&&this.render()}render(){const t=this.hasAttribute("copy"),i=this.getAttribute("language")||"text";this.shadowRoot.innerHTML=`
            <style>
            :host {
                position: relative;
                display: block;
...
`)}_unescapeHtml(t){const i=document.createElement("textarea");return i.innerHTML=t,i.value}_highlight(t,i){t=t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");const e={};let n=0;function o(a,c){const d=`__TOKEN_${c}_${n++}__`;return e[d]=`<span class="token ${c}">${a}</span>`,d}return["javascript","js","json","bash","sh","css"].includes(i)?(t=t.replace(/("(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,a=>o(a,"string")),i==="bash"||i==="sh"?t=t.replace(/(#.*$)/gm,a=>o(a,"comment")):i==="css"?t=t.replace(/(\/\*[\s\S]*?\*\/)/g,a=>o(a,"comment")):t=t.replace(/(\/\/.*$|\/\*[\s\S]*?\*\/)/gm,a=>o(a,"comment"))):["html","xml"].includes(i)&&(t=t.replace(/(&lt;!--[\s\S]*?--&gt;)/g,a=>o(a,"comment")),t=t.replace(/(&lt;\/?[a-z0-9:-]+)/gi,a=>o(a,"tag"))),i==="javascript"||i==="js"||i==="json"?(t=t.replace(/\b(const|let|var|if|else|for|while|return|function|class|import|export|from|default|switch|case|break|continue|new|this|async|await)\b/g,'<span class="token keyword">$1</span>'),t=t.replace(/\b(true|false|null|undefined)\b/g,'<span class="token boolean">$1</span>'),t=t.replace(/\b([a-zA-Z0-9_]+)\s*(?=\()/g,'<span class="token function">$1</span>')):i==="bash"||i==="sh"?(t=t.replace(/\b(npm|npx|node|git|cd|ls|mkdir|rm|mv|cp|echo|cat|sudo|docker|brew|grep|curl|wget|chmod|chown|touch)\b/g,'<span class="token keyword">$1</span>'),t=t.replace(/\b(install|run|build|start|test|dev|init|clone|pull|push|commit|add|checkout|branch|merge)\b/g,'<span class="token function">$1</span>'),t=t.replace(/(\s-+[a-zA-Z0-9-]+)/g,'<span class="token attr-name">$1</span>'),t=t.replace(/(\$[A-Z0-9_]+)/g,'<span class="token number">$1</span>')):i==="html"||i==="xml"?(t=t.replace(/\s([a-z0-9:-]+)=/gi,(a,c)=>" "+o(c,"attr-name")+"="),t=t.replace(/(".*?")/g,a=>o(a,"attr-value")),t=t.replace(/&gt;/g,'<span class="token tag">&gt;</span>')):i==="css"&&(t=t.replace(/([a-z-]+)(?=:)/g,'<span class="token keyword">$1</span>')),Object.keys(e).reverse().forEach(a=>{t=t.replace(a,e[a])}),t}_onCopy(){L(this._getFormattedText());const t=this.copyBtn.querySelector("eui-icon");if(t){const i=t.getAttribute("name");t.setAttribute("name","check"),setTimeout(()=>t.setAttribute("name",i),2e3)}}disconnectedCallback(){this.copyBtn&&this.copyBtn.removeEventListener("click",this._boundCopy)}}customElements.define("eui-code",Z);class J extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}static get observedAttributes(){return["name"]}attributeChangedCallback(t,i,e){t==="name"&&(this.render(),this.setupEventListeners())}setupEventListeners(){const t=this.shadowRoot.querySelector("#nav-toggle");t&&t.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("toggle-nav"))})}render(){const t=this.getAttribute("name")||"Title";this.shadowRoot.innerHTML=`
        ...
        `}}customElements.define("eui-tab-bar",G);class Q extends HTMLElement{constructor(){super();x(this,"handleClick",()=>{const i=this.getAttribute("path");i&&f.navigate(i)});this.attachShadow({mode:"open"})}static get observedAttributes(){return["path","icon","label","badge","active","avatar-src","avatar-name"]}connectedCallback(){this.hasRendered||(this.render(),this.setupEventListeners(),this.hasRendered=!0),this.updateContent(),this.updateActiveState(),this.addEventListener("click",this.handleClick),this._onRouteSubstitute=()=>this.updateActiveState(),window.addEventListener("popstate",this._onRouteSubstitute),window.addEventListener("route-changed",this._onRouteSubstitute)}disconnectedCallback(){this.removeEventListener("click",this.handleClick),window.removeEventListener("popstate",this._onRouteSubstitute),window.removeEventListener("route-changed",this._onRouteSubstitute)}attributeChangedCallback(i,e,n){if(e!==n&&this.hasRendered){if(i==="active")return;this.updateContent(),i==="path"&&this.updateActiveState()}}updateActiveState(){let i=f.location(),e=this.getAttribute("path");i.startsWith("/")||(i="/"+i),e&&!e.startsWith("/")&&(e="/"+e),e&&i===e?this.setAttribute("active",""):this.removeAttribute("active")}setupEventListeners(){this.addEventListener("pointerdown",i=>{const e=document.createElement("span"),n=i.currentTarget,o=n.getBoundingClientRect(),a=Math.max(n.offsetWidth,n.offsetHeight),c=a/2;e.classList.add("ripple"),e.style.width=`${a}px`,e.style.height=`${a}px`,e.style.left=`${i.clientX-o.left-c}px`,e.style.top=`${i.clientY-o.top-c}px`,this.shadowRoot.appendChild(e),e.addEventListener("animationend",()=>{e.remove()})})}updateContent(){const i=this.getAttribute("icon"),e=this.getAttribute("avatar-src"),n=this.getAttribute("avatar-name"),o=this.getAttribute("label")||"",a=this.getAttribute("badge"),c=this.shadowRoot.querySelector(".badge");if(a)if(c)c.textContent=a;else{const l=document.createElement("span");l.className="badge",l.textContent=a,this.shadowRoot.appendChild(l)}else c&&c.remove();const d=this.shadowRoot.querySelector("slot[name='icon']");if(d)if(e||n){let l='<eui-avatar size="24"';n&&(l+=` name="${n}"`),l+=">",e&&(l+=`<img src="${e}" alt="${n||"Avatar"}" />`),l+="</eui-avatar>",d.innerHTML=l}else i?d.innerHTML=`<eui-icon width="20" height="20" name="${i}"></eui-icon>`:d.innerHTML="";const r=this.shadowRoot.querySelector(".label");r&&(r.textContent=o)}render(){this.shadowRoot.innerHTML=`
            ...
            <div class="inner">
                ...
                <span class="label"></span>
            <slot></slot>
        `}}customElements.define("eui-tab-item",Q),typeof window<"u"&&console.log("ErisUI loaded successfully"),h.device=$,h.haptics=H,h.icons=p,h.loadPage=q,h.router=f,h.storage=F,h.utils=W,Object.defineProperty(h,Symbol.toStringTag,{value:"Module"})}));
