(function(h,b){typeof exports=="object"&&typeof module<"u"?b(exports):typeof define=="function"&&define.amd?define(["exports"],b):(h=typeof globalThis<"u"?globalThis:h||self,b(h.eui={}))})(this,(function(h){"use strict";var et=Object.defineProperty;var it=(h,b,p)=>b in h?et(h,b,{enumerable:!0,configurable:!0,writable:!0,value:p}):h[b]=p;var x=(h,b,p)=>it(h,typeof b!="symbol"?b+"":b,p);class b extends HTMLElement{static get observedAttributes(){return["size","border-radius","name","color"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host {
                    aspect-ratio: 1 / 1;
                    width: fit-content;
        ...
        `}set value(t){this.setAttribute("value",t)}set intermediate(t){t?this.setAttribute("intermediate",""):this.removeAttribute("intermediate")}set id(t){this.setAttribute("id",t)}get intermediate(){return this.hasAttribute("intermediate")}get value(){return this.getAttribute("value")}attributeChangedCallback(){this.connectedCallback()}connectedCallback(){const t=this.shadowRoot.querySelector(".progress");this.hasAttribute("id")&&(t.id=this.getAttribute("id")),this.hasAttribute("intermediate")?t.classList.add("intermediate"):t.classList.remove("intermediate"),this.hasAttribute("value")&&(t.style.width=this.getAttribute("value")+"%")}}customElements.define("eui-progressbar",M);const w={is:{iPhone:/iPhone/.test(navigator.userAgent),iPad:/iPad/.test(navigator.userAgent),iOS:/iPhone|iPad|iPod/.test(navigator.userAgent),android:/Android/.test(navigator.userAgent),mobile:/Mobi|Android/i.test(navigator.userAgent)},prefers:{language:navigator.language||navigator.userLanguage,reducedMotion:window.matchMedia("(prefers-reduced-motion: reduce)").matches,reducedTransparency:window.matchMedia("(prefers-reduced-transparency: reduce)").matches},supports:{share:typeof navigator.share=="function",directDownload:"download"in document.createElement("a"),haptics:"vibrate"in navigator||"Vibrate"in window||typeof window.navigator.vibrate=="function"},userAgent:navigator.userAgent},R=Object.freeze(Object.defineProperty({__proto__:null,device:w},Symbol.toStringTag,{value:"Module"}));function $(){try{const n=document.createElement("label");n.ariaHidden="true",n.style.display="none";const t=document.createElement("input");t.type="checkbox",t.setAttribute("switch",""),n.appendChild(t),document.head.appendChild(n),n.click(),document.head.removeChild(n)}catch{}}function y(n){w.supports.haptics?navigator.vibrate(n||50):w.is.iPhone&&$()}const H=Object.freeze(Object.defineProperty({__proto__:null,haptic:y},Symbol.toStringTag,{value:"Module"})),E=(()=>{let n={},t;try{n=JSON.parse(localStorage.getItem(t)||"{}")}catch(i){console.error(i)}return{get(i){return n[i]},set(i,e){n[i]=e,localStorage.setItem(t,JSON.stringify(n))},delete(i){delete n[i],localStorage.setItem(t,JSON.stringify(n))},all(){return n},clear(){n={},localStorage.setItem(t,JSON.stringify(n))},name(i){t=i;try{n=JSON.parse(localStorage.getItem(t)||"{}")}catch(e){console.error(e)}},settings:{get(i){return n&&n.settings&&n.settings[i]},set(i,e){n.settings||(n.settings={}),n.settings[i]=e,localStorage.setItem(t,JSON.stringify(n))},delete(i){n.settings&&(delete n.settings[i],localStorage.setItem(t,JSON.stringify(n)))},all(){return n.settings||{}},clear(){n.settings&&(n.settings={},localStorage.setItem(t,JSON.stringify(n)))}}}})(),_=E.settings,I=Object.freeze(Object.defineProperty({__proto__:null,settings:_,storage:E},Symbol.toStringTag,{value:"Module"}));class F extends HTMLElement{static get observedAttributes(){return["selected"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                .switch {
        ...
        `}connectedCallback(){this.inputEl=this.shadowRoot.querySelector("input"),this.switchEl=this.shadowRoot.querySelector(".switch"),this.updateFromAttribute(),this.switchEl.addEventListener("click",()=>this.toggle())}toggle(){this.selected=!this.selected,y(),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}updateFromAttribute(){const t=this.hasAttribute("selected");this.inputEl.checked=t,this.switchEl.classList.toggle("selected",t)}attributeChangedCallback(t,i,e){t==="selected"&&this.inputEl&&this.updateFromAttribute()}get selected(){return this.hasAttribute("selected")}set selected(t){t?this.setAttribute("selected",""):this.removeAttribute("selected")}}customElements.define("eui-switch",F);class j extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.shadowRoot.innerHTML=`
            ...
            <slot></slot>
        `,this.addEventListener("pointerdown",t=>{const i=document.createElement("span"),e=t.currentTarget,s=Math.max(e.offsetWidth,e.offsetHeight);i.classList.add("ripple"),i.style.left=t.clientX-e.getBoundingClientRect().left-s/2+"px",i.style.top=t.clientY-e.getBoundingClientRect().top-s/2+"px",i.style.width=s+"px",i.style.height=s+"px",this.shadowRoot.appendChild(i),setTimeout(()=>{i.remove()},600)})}}customElements.define("eui-chip",j);const v="",f=(()=>{const n=[];function t(a,l){const u=[],m=a.replace(/:([^/]+)/g,(k,C)=>(u.push(C),"([^/]+)")).replace(/\//g,"\\/"),g=new RegExp(`^${v}${m}$`);n.push({regex:g,paramNames:u,renderFn:l})}function i(a){for(const{regex:l,paramNames:u,renderFn:m}of n){const g=a.match(l);if(g){const k={};return u.forEach((C,tt)=>{k[C]=decodeURIComponent(g[tt+1])}),{renderFn:m,params:k}}}return null}function e(a,l=!0){a.startsWith(v)||(a=v+(a.startsWith("/")?"":"/")+a);const u=a.split(/[?#]/)[0];if(u===window.location.pathname&&a.includes("#")){l&&history.pushState({},"",a);const g="#"+a.split("#")[1];s(g);return}const m=i(u);if(m)if(l&&history.pushState({},"",a),m.renderFn(m.params),window.dispatchEvent(new CustomEvent("route-changed",{detail:{path:a}})),a.includes("#")){const g="#"+a.split("#")[1];setTimeout(()=>s(g),100)}else{const g=document.getElementById("main");g&&g.scrollTo(0,0)}else o?(l&&history.pushState({},"",a),o()):console.warn(`No route found for ${u}`)}function s(a){if(a)try{const l=document.querySelector(a);l&&l.scrollIntoView({behavior:"smooth"})}catch{console.warn("Invalid hash:",a)}}let o=null;function r(a){o=a}function c(){history.back()}function d(){return window.location.pathname.replace(v,"")||"/"}return window.addEventListener("popstate",()=>{const a=window.location.pathname+window.location.search+window.location.hash;e(a,!1)}),window.addEventListener("click",a=>{if(a.button!==0||a.metaKey||a.altKey||a.ctrlKey||a.shiftKey)return;const l=a.target.closest("a");if(!l||l.hasAttribute("download")||l.getAttribute("target")==="_blank")return;const u=l.getAttribute("href");if(!(!u||u.startsWith("http")&&!u.startsWith(window.location.origin))){if(a.preventDefault(),u.startsWith("#")){history.pushState({},"",u),s(u);return}e(u)}}),{add:t,navigate:e,back:c,location:d,setNotFound:r}})();async function q(n){try{const t=document.getElementById("main");t.classList.add("fade-out"),await new Promise(e=>setTimeout(e,200));const i=await fetch(`/src/pages/${n}.html`).then(e=>e.text());t.innerHTML=i,t.classList.remove("fade-out"),t.classList.add("fade-in"),window.location.hash?setTimeout(()=>{try{const e=document.querySelector(window.location.hash);e&&e.scrollIntoView({behavior:"smooth"})}catch{}},100):t&&t.scrollTo(0,0),setTimeout(()=>{t.classList.remove("fade-in")},200)}catch(t){console.error("Page load failed:",t)}}class B extends HTMLElement{constructor(){super();x(this,"handleClick",()=>{const i=this.getAttribute("path");i&&f.navigate(i)});this.attachShadow({mode:"open"})}static get observedAttributes(){return["path","icon","label","badge","active","avatar-src","avatar-name"]}connectedCallback(){this.hasRendered||(this.render(),this.setupEventListeners(),this.hasRendered=!0),this.updateContent(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.removeEventListener("click",this.handleClick)}attributeChangedCallback(i,e,s){if(e!==s&&this.hasRendered){if(i==="active")return;this.updateContent()}}setupEventListeners(){this.addEventListener("pointerdown",i=>{const e=document.createElement("span"),s=i.currentTarget,o=s.getBoundingClientRect(),r=Math.max(s.offsetWidth,s.offsetHeight),c=r/2;e.classList.add("ripple"),e.style.width=`${r}px`,e.style.height=`${r}px`,e.style.left=`${i.clientX-o.left-c}px`,e.style.top=`${i.clientY-o.top-c}px`,this.shadowRoot.appendChild(e),e.addEventListener("animationend",()=>{e.remove()})})}updateContent(){const i=this.getAttribute("icon"),e=this.getAttribute("avatar-src"),s=this.getAttribute("avatar-name"),o=this.getAttribute("label")||"",r=this.getAttribute("badge"),c=this.shadowRoot.querySelector(".badge");if(r)if(c)c.textContent=r;else{const l=document.createElement("span");l.className="badge",l.textContent=r,this.shadowRoot.appendChild(l)}else c&&c.remove();const d=this.shadowRoot.querySelector("slot[name='icon']");if(d)if(e||s){let l='<eui-avatar size="24"';s&&(l+=` name="${s}"`),l+=">",e&&(l+=`<img src="${e}" alt="${s||"Avatar"}" />`),l+="</eui-avatar>",d.innerHTML=l}else{const l=d.querySelector("eui-icon");i&&l?l.getAttribute("name")!==i&&l.setAttribute("name",i):i?d.innerHTML=`<eui-icon width="24" height="24" name="${i}"></eui-icon>`:d.innerHTML=""}const a=this.shadowRoot.querySelector(".label");a&&(a.textContent=o)}render(){this.shadowRoot.innerHTML=`
        <style>
            :host {
                position: relative;
                overflow: hidden;
        ...
        `}connectedCallback(){this.hd=this.shadowRoot.querySelector(".header"),this.hasAttribute("type")&&this.hd.classList.add(this.getAttribute("type"))}attributeChangedCallback(t,i,e){const s=this.shadowRoot.querySelector("h1"),o=this.shadowRoot.querySelector("p"),r=this.shadowRoot.querySelector(".img");t==="title"&&(s.textContent=e),t==="subtitle"&&(o.textContent=e),t==="img"&&(r.style.backgroundImage=e?`url(${e})`:"")}}customElements.define("eui-header",O);class P extends HTMLElement{static get observedAttributes(){return["selected"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host {
                    display: inline-block;
        ...
        `;const e=this.shadowRoot.querySelector(i);t&&e.setAttribute("href",t),this.hasAttribute("type")&&e.classList.add(this.getAttribute("type")),this.hasAttribute("icon")&&e.classList.add("icon"),this.hasAttribute("width")&&(e.style.width=this.getAttribute("width")+"px"),this.hasAttribute("height")&&(e.style.height=this.getAttribute("height")+"px"),this.hasAttribute("border-radius")&&(e.style.borderRadius=this.getAttribute("border-radius")+"px"),e.addEventListener("pointerdown",s=>{const o=document.createElement("span"),r=s.currentTarget,c=r.getBoundingClientRect(),d=Math.max(r.offsetWidth,r.offsetHeight),a=d/2;o.classList.add("ripple"),o.style.width=`${d}px`,o.style.height=`${d}px`,o.style.left=`${s.clientX-c.left-a}px`,o.style.top=`${s.clientY-c.top-a}px`,e.appendChild(o),o.addEventListener("animationend",()=>{o.remove()})})}}x(A,"observedAttributes",["type","width","height","border-radius","icon","link","href"]),customElements.define("eui-button",A);class U extends HTMLElement{static get observedAttributes(){return["type","anchor"]}constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.hd=this.shadowRoot.querySelector(".hd"),this.hasAttribute("type")&&this.hd.classList.add(this.getAttribute("type"))}render(){this.shadowRoot.innerHTML=`
            <style>
                :host {
                    display: block;
                    position: relative;
            ...
            `:""}
        `}}customElements.define("eui-heading",U);function D(n){const e=Date.now()-n,s=Math.floor(e/1e3),o=Math.floor(s/60),r=Math.floor(o/60),c=Math.floor(r/24),d=Math.floor(c/30),a=Math.floor(d/12);return a>0?`${a}y`:d>0?`${d}mo`:c>0?`${c}d`:r>0?`${r}h`:o>0?`${o}m`:`${s}s`}function X(n){const e=Date.now()-n,s=Math.floor(e/1e3),o=Math.floor(s/60),r=Math.floor(o/60),c=Math.floor(r/24),d=Math.floor(c/30),a=Math.floor(d/12);return a>0?`${a} year${a>1?"s":""} ago`:d>0?`${d} month${d>1?"s":""} ago`:c>0?`${c} day${c>1?"s":""} ago`:r>0?`${r} hour${r>1?"s":""} ago`:o>0?`${o} minute${o>1?"s":""} ago`:`${s} second${s>1?"s":""} ago`}function Z(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;").replace(/`/g,"&#96;").replace(/'/g,"&#39;")}function L(n){const t=document.createElement("input");t.value=n,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}const W=Object.freeze(Object.defineProperty({__proto__:null,copystr:L,joinedAgo:X,sanitize:Z,timeAgo:D},Symbol.toStringTag,{value:"Module"}));class V extends HTMLElement{static get observedAttributes(){return["copy","id","type","language"]}constructor(){super(),this.attachShadow({mode:"open"}),this._boundCopy=this._onCopy.bind(this),this._isRendered=!1}connectedCallback(){this._isRendered||(this.render(),this._isRendered=!0)}attributeChangedCallback(t,i,e){this._isRendered&&i!==e&&this.render()}render(){const t=this.hasAttribute("copy"),i=this.getAttribute("language")||"text";this.shadowRoot.innerHTML=`
            <style>
            :host {
                position: relative;
                display: block;
...
`),s=e.filter(r=>r.trim()).map(r=>r.match(/^\s*/)[0].length),o=s.length?Math.min(...s):0;return e.map(r=>r.slice(o)).join(`
`)}_unescapeHtml(t){const i=document.createElement("textarea");return i.innerHTML=t,i.value}_highlight(t,i){t=t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");const e={};let s=0;function o(r,c){const d=`__TOKEN_${c}_${s++}__`;return e[d]=`<span class="token ${c}">${r}</span>`,d}return["javascript","js","json","bash","sh","css"].includes(i)?(t=t.replace(/("(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')/g,r=>o(r,"string")),i==="bash"||i==="sh"?t=t.replace(/(#.*$)/gm,r=>o(r,"comment")):i==="css"?t=t.replace(/(\/\*[\s\S]*?\*\/)/g,r=>o(r,"comment")):t=t.replace(/(\/\/.*$|\/\*[\s\S]*?\*\/)/gm,r=>o(r,"comment"))):["html","xml"].includes(i)&&(t=t.replace(/(&lt;!--[\s\S]*?--&gt;)/g,r=>o(r,"comment")),t=t.replace(/(&lt;\/?[a-z0-9:-]+)/gi,r=>o(r,"tag"))),i==="javascript"||i==="js"||i==="json"?(t=t.replace(/\b(const|let|var|if|else|for|while|return|function|class|import|export|from|default|switch|case|break|continue|new|this|async|await)\b/g,'<span class="token keyword">$1</span>'),t=t.replace(/\b(true|false|null|undefined)\b/g,'<span class="token boolean">$1</span>'),t=t.replace(/\b([a-zA-Z0-9_]+)\s*(?=\()/g,'<span class="token function">$1</span>')):i==="bash"||i==="sh"?(t=t.replace(/\b(npm|npx|node|git|cd|ls|mkdir|rm|mv|cp|echo|cat|sudo|docker|brew|grep|curl|wget|chmod|chown|touch)\b/g,'<span class="token keyword">$1</span>'),t=t.replace(/\b(install|run|build|start|test|dev|init|clone|pull|push|commit|add|checkout|branch|merge)\b/g,'<span class="token function">$1</span>'),t=t.replace(/(\s-+[a-zA-Z0-9-]+)/g,'<span class="token attr-name">$1</span>'),t=t.replace(/(\$[A-Z0-9_]+)/g,'<span class="token number">$1</span>')):i==="html"||i==="xml"?(t=t.replace(/\s([a-z0-9:-]+)=/gi,(r,c)=>" "+o(c,"attr-name")+"="),t=t.replace(/(".*?")/g,r=>o(r,"attr-value")),t=t.replace(/&gt;/g,'<span class="token tag">&gt;</span>')):i==="css"&&(t=t.replace(/([a-z-]+)(?=:)/g,'<span class="token keyword">$1</span>')),Object.keys(e).reverse().forEach(r=>{t=t.replace(r,e[r])}),t}_onCopy(){L(this._getFormattedText());const t=this.copyBtn.querySelector("eui-icon");if(t){const i=t.getAttribute("name");t.setAttribute("name","check"),setTimeout(()=>t.setAttribute("name",i),2e3)}}disconnectedCallback(){this.copyBtn&&this.copyBtn.removeEventListener("click",this._boundCopy)}}customElements.define("eui-code",V);class J extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupEventListeners()}static get observedAttributes(){return["name"]}attributeChangedCallback(t,i,e){t==="name"&&(this.render(),this.setupEventListeners())}setupEventListeners(){const t=this.shadowRoot.querySelector("#nav-toggle");t&&t.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("toggle-nav"))})}render(){const t=this.getAttribute("name")||"Title";this.shadowRoot.innerHTML=`
        <style>
            :host {
                display: block;
                width: 100%;
        ...
        `}}customElements.define("eui-surface",Y);class K extends HTMLElement{static get observedAttributes(){return["value","min","max","step","label","vertical","disabled","thickness"]}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`
            <style>
                :host {
                    display: flex;
                    flex-direction: column;
        ...
        `}}customElements.define("eui-tab-bar",G);class Q extends HTMLElement{constructor(){super();x(this,"handleClick",()=>{const i=this.getAttribute("path");i&&f.navigate(i)});this.attachShadow({mode:"open"})}static get observedAttributes(){return["path","icon","label","badge","active","avatar-src","avatar-name"]}connectedCallback(){this.hasRendered||(this.render(),this.setupEventListeners(),this.hasRendered=!0),this.updateContent(),this.updateActiveState(),this.addEventListener("click",this.handleClick),this._onRouteSubstitute=()=>this.updateActiveState(),window.addEventListener("popstate",this._onRouteSubstitute),window.addEventListener("route-changed",this._onRouteSubstitute)}disconnectedCallback(){this.removeEventListener("click",this.handleClick),window.removeEventListener("popstate",this._onRouteSubstitute),window.removeEventListener("route-changed",this._onRouteSubstitute)}attributeChangedCallback(i,e,s){if(e!==s&&this.hasRendered){if(i==="active")return;this.updateContent(),i==="path"&&this.updateActiveState()}}updateActiveState(){let i=f.location(),e=this.getAttribute("path");i.startsWith("/")||(i="/"+i),e&&!e.startsWith("/")&&(e="/"+e),e&&i===e?this.setAttribute("active",""):this.removeAttribute("active")}setupEventListeners(){this.addEventListener("pointerdown",i=>{const e=document.createElement("span"),s=i.currentTarget,o=s.getBoundingClientRect(),r=Math.max(s.offsetWidth,s.offsetHeight),c=r/2;e.classList.add("ripple"),e.style.width=`${r}px`,e.style.height=`${r}px`,e.style.left=`${i.clientX-o.left-c}px`,e.style.top=`${i.clientY-o.top-c}px`,this.shadowRoot.appendChild(e),e.addEventListener("animationend",()=>{e.remove()})})}updateContent(){const i=this.getAttribute("icon"),e=this.getAttribute("avatar-src"),s=this.getAttribute("avatar-name"),o=this.getAttribute("label")||"",r=this.getAttribute("badge"),c=this.shadowRoot.querySelector(".badge");if(r)if(c)c.textContent=r;else{const l=document.createElement("span");l.className="badge",l.textContent=r,this.shadowRoot.appendChild(l)}else c&&c.remove();const d=this.shadowRoot.querySelector("slot[name='icon']");if(d)if(e||s){let l='<eui-avatar size="24"';s&&(l+=` name="${s}"`),l+=">",e&&(l+=`<img src="${e}" alt="${s||"Avatar"}" />`),l+="</eui-avatar>",d.innerHTML=l}else i?d.innerHTML=`<eui-icon width="20" height="20" name="${i}"></eui-icon>`:d.innerHTML="";const a=this.shadowRoot.querySelector(".label");a&&(a.textContent=o)}render(){this.shadowRoot.innerHTML=`
            ...
            <div class="inner">
                ...
                <span class="label"></span>
            <slot></slot>
        `}}customElements.define("eui-tab-item",Q),typeof window<"u"&&console.log("ErisUI loaded successfully"),h.device=R,h.haptics=H,h.icons=p,h.loadPage=q,h.router=f,h.storage=I,h.utils=W,Object.defineProperty(h,Symbol.toStringTag,{value:"Module"})}));
